...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	float fConst12 = (1.3380459e-09f * fConst0);
	fConst13 = (fConst12 + -5.57205567e-07f);
	float fConst14 = (2.32703634e-09f * fConst0);
	fConst15 = (4.84526595e-07f - fConst14);
	fConst16 = (1.0117549e-09f * fConst0);
	fConst17 = (fConst12 + 5.57205567e-07f);
	fConst18 = (-4.84526595e-07f - fConst14);
	float fConst19 = (7.43339834e-10f * fConst0);
	fConst20 = (-1.47050536e-12f - fConst19);
	float fConst21 = (1.2927649e-09f * fConst0);
	fConst22 = (fConst21 + 1.27870034e-12f);
	fConst23 = (1.47050536e-12f - fConst19);
	fConst24 = (fConst21 + -1.27870034e-12f);
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		float fTemp5 = ((fConst0 * (fConst17 + (fRec7[0] * (fConst18 + fTemp4)))) + 5.22587875e-08f);
		fRec6[0] = ((fConst0 * (fTemp3 / fTemp1)) - (((fRec6[1] * ((fConst11 * ((fRec7[0] * ((0.0f - (2.0235098e-09f * fRec7[0])) + 4.65407268e-09f)) + -2.67609179e-09f)) + 1.04517575e-07f)) + (fRec6[2] * ((fConst0 * (fConst13 + (fRec7[0] * (fConst15 + fTemp4)))) + 5.22587875e-08f))) / fTemp5));
		float fTemp6 = (fConst0 * (0.0f - (5.62071722e-10f * fRec7[0])));
		fRec5[0] = (((((fRec6[0] * ((fConst0 * (fConst20 + (fRec7[0] * (fConst22 + fTemp6)))) + -2.90320481e-18f)) + (fRec6[1] * ((fConst11 * ((fRec7[0] * ((1.12414344e-09f * fRec7[0]) + -2.58552979e-09f)) + 1.48667967e-09f)) + -5.80640961e-18f))) + (fRec6[2] * ((fConst0 * (fConst23 + (fRec7[0] * (fConst24 + fTemp6)))) + -2.90320481e-18f))) / fTemp5) - (fConst25 * fRec5[1]));
